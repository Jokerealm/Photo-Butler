...
import { useNetworkStatus } from '../services/retryService';
...
const NetworkStatusIndicator: React.FC = () => {
  ...
  if (isOnline && isConnected !== false) {
    return null; // Don't show anything if network is fine
  }
          ...
          <div className="bg-white py-6 sm:py-8 px-4 sm:px-6 shadow sm:rounded-lg">
            ...
            {errorId && (
              <div className="bg-gray-50 rounded-md p-3 mb-4 sm:mb-6">
                <div className="text-sm">
                  ...
                  <span className="font-mono text-gray-900 break-all">{errorId}</span>
                </div>
              </div>
            )}
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex justify-center py-2.5 sm:py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors touch-manipulation"
              >
                重试
              </button>
              ...
              <button
                ...
                className="w-full flex justify-center py-2.5 sm:py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 active:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors touch-manipulation"
              >
                刷新页面
              </button>
